...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        for train_step in range(train_step_num):
            ...
            # print("train_batch_src_inp")
            # print(train_batch_src_inp)
            # print("train_batch_tgt")
            # print(train_batch_tgt)
            # print("%%%%%%%%%训练数据%%%%%%%%%%%")
            # 16个seq，每个seq中是token_id
            train_batch_src_inp = torch.LongTensor(train_batch_src_inp).cuda(device) # (16,seq_lenth)
            # tgt的seq_lenth就明显短很多，很多都是padding
            ...
            for index in range(tgt_len):
                curr_step_log_prob = train_log_prob_matrix_unbind[index] #[16,vocab_size]
                curr_step_tgt = train_truth_tgt_unbind[index].view(bsz) #Tensor:16,
